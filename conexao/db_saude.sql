...
CREATE TABLE HOSPITAL(
	...
	cepHospital VARCHAR(8) NOT NULL,
...
CREATE TABLE UNIDADE_SAUDE(
    ...
    CRM INT NOT NULL REFERENCES TIPO_UNIDADE(idTipoUnidade)
)
ENGINE INNODB;
...
(NULL, "usuário-unidade"), 
(NULL, "usuário-hospital");
...
INSERT INTO USUARIO VALUES(NULL, 'Erik Gabriel', 'erik2203', 1, 1)