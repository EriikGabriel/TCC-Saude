  ...
  $(document).on("click", ".btn-delete", function (e) {
    ...
    $.ajax({
      ...
      success: function (dados) {
        ...
        if (dados.count > 0) {       
          var text = "O registro que será deletado está sendo usado como referência em outras tabelas, ao confirmar, você corre o risco de perder todos os registros ligados a essa Unidade de Saúde"
        } else {
